...
char VerifyIPAddress(char* src, uint8 * ip);/* Verify dotted notation IP address string */
...
uint8 CheckDestInLocal(u_long destip);			/* Check Destination in local or remote */
